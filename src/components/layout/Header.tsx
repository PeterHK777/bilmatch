...
import { Search, Heart, User, Menu, X, Phone, Car } from "lucide-react";
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-gray-200">
          <nav className="max-w-7xl mx-auto px-4 py-4 space-y-3">
            ...
            <Link
              href="/mine/favoritter"
              className="flex items-center gap-2 py-2 text-gray-700 hover:text-primary font-medium"
              onClick={() => setMobileMenuOpen(false)}
            >
              <Heart className="w-5 h-5" />
              Favoritter
